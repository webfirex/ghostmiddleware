...
//  CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift?toolId=cfe53441-c3d1-41cd-bd7d-51cf415b1a66", // spx
 CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift/c28e2bd4-7f95-4cc3-bd20-65730a60548f", // spy
...
if ($data && isset($data['response']['netDrift'])) {
    ...
    if (file_put_contents('netflowdatatsla.json', $modifiedResponse)) {
