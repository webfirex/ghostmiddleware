...
//  CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift?toolId=cfe53441-c3d1-41cd-bd7d-51cf415b1a66", // spx
 CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift/8f5f440f-093f-495a-9b68-e799f663efbe", // spy
...
if ($data && isset($data['response']['netDrift'])) {
    ...
    if (file_put_contents('netflowdatanflx.json', $modifiedResponse)) {
