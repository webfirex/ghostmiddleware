...
curl_setopt_array($curl, [
 CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift/42d2d994-9228-487e-81bf-42e69cd3a74c",
...
if ($data && isset($data['response']['netDrift'])) {
    ...
    if (file_put_contents('netflowdatasqqq.json', $modifiedResponse)) {
