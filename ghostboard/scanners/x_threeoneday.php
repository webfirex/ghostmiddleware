...
function fetchTickers() {
    $url = 'https://testapi.webepex.com/ghostboard/scanners/tickers/threeonedaytickers.php';
...
if (empty($allData)) {
    ...
    file_put_contents('threeoneday.json', json_encode($allData, JSON_PRETTY_PRINT));
