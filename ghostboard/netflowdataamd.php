...
//  CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift?toolId=cfe53441-c3d1-41cd-bd7d-51cf415b1a66", // spx
 CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift/a9ca60d8-9ec8-44f6-bb98-17e76e7c6066", // spy
...
if ($data && isset($data['response']['netDrift'])) {
    ...
    if (file_put_contents('netflowdataamd.json', $modifiedResponse)) {
