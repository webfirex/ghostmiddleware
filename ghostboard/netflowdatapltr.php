...
//  CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift?toolId=cfe53441-c3d1-41cd-bd7d-51cf415b1a66", // spx
 CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift/3ea2c5cb-c417-4fc2-89c3-674516f27ea5", // spy
...
if ($data && isset($data['response']['netDrift'])) {
    ...
    if (file_put_contents('netflowdatapltr.json', $modifiedResponse)) {
