...
curl_setopt_array($ch, [
  CURLOPT_URL => "https://v3.quantdata.us/api/equities/dark-flow/d844fce9-e124-4592-a289-29e60913ec28",
...
if (isset($marketData['response']['tradeTimeToDarkFlowDataSumModelMap'])) {
    $data = &$marketData['response']['tradeTimeToDarkFlowDataSumModelMap'];

    // Sort the array by its keys (timestamps)
    ksort($data, SORT_NUMERIC);
}

// Save the transformed data to JSON
$outputFile = 'spyAI.json';
...
curl_setopt_array($ch, [
  CURLOPT_URL => "https://v3.quantdata.us/api/equities/dark-flow/0bff4751-3d24-4aad-a6e4-01c521703469",
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => "",
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
