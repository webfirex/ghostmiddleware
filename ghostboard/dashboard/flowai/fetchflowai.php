...
$marketDataApiUrl = 'https://api.ghostboard.net/v1/alerts?symbol=null&PUT&CALL&repeat&heavy&golden';
...
if (empty($marketData) || !is_array($marketData) || count($marketData['result']) === 0) {
