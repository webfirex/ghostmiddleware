...
//  CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift?toolId=cfe53441-c3d1-41cd-bd7d-51cf415b1a66", // spx
 CURLOPT_URL => "https://v3.quantdata.us/api/options/net-drift/f228a6ce-f933-4455-81a8-72773d7c026c", // spy
...
if ($data && isset($data['response']['netDrift'])) {
    ...
    if (file_put_contents('netflowdatababa.json', $modifiedResponse)) {
        echo "Data successfully saved to netflowdata.json";
    } else {
        echo "Error saving data to netflowdata.json";
    }
} else {
